...
- [ ] 1.0 Complete backend multi-category filtering
  - [ ] 1.1 Write 4 focused tests for multi-category filtering
  ...
  - [ ] 1.2 Update router parameter from `category_type` to `category`
  ...
  - [ ] 1.3 Update service function signature and filter logic
...
- [ ] 2.0 Complete frontend foundation setup
  ...
  - [ ] 2.3 Add TransactionFilters type and DEFAULT_FILTERS constant
  ...
  - [ ] 2.4 Add getActiveFilterCount utility function
...
- [ ] 3.0 Complete API client filter support
  - [ ] 3.1 Write 3 focused tests for API client filter params
  ...
  - [ ] 3.2 Update getMonthDetail function signature
    - File: `frontend/lib/api-client.ts`
    - Add optional `filters?: TransactionFilters` parameter
  - [ ] 3.3 Implement filter param serialization
  ...
  - [ ] 3.4 Ensure API client tests pass
...
- [ ] 4.0 Complete dashboard filter state management
  - [ ] 4.1 Write 4 focused tests for filter state management
  ...
  - [ ] 4.5 Update SELECT_MONTH case to reset filters
    - Reset filters to DEFAULT_FILTERS when month changes
  - [ ] 4.6 Update initialState with DEFAULT_FILTERS
    - Add `filters: DEFAULT_FILTERS` to initial reducer state
  - [ ] 4.7 Ensure reducer tests pass
...
- [ ] 5.0 Complete filter-aware data fetching
  - [ ] 5.1 Update useEffect dependency array
    - File: `frontend/components/dashboard/dashboard-client.tsx`
    - Add `state.filters` to the dependency array of the monthDetail fetch effect
  - [ ] 5.2 Pass filters to getMonthDetail call
    - Update the API call to include `state.filters` parameter
  - [ ] 5.3 Create handleFiltersChange callback
...
- [ ] 6.0 Complete TransactionFilters component
  - [ ] 6.1 Write 5 focused tests for TransactionFilters
  ...
  - [ ] 6.2 Create component file and props interface
  ...
  - [ ] 6.3 Implement category multi-select dropdown
  ...
  - [ ] 6.4 Implement date range pickers
  ...
  - [ ] 6.5 Implement debounced search input
  ...
  - [ ] 6.6 Implement clear filters button and active count badge
    - Show clear button only when getActiveFilterCount > 0
    - Display Badge with active filter count
  - [ ] 6.7 Ensure TransactionFilters tests pass
...
- [ ] 7.0 Complete TransactionTable filter integration
  ...
  - [ ] 7.4 Update DashboardClient to pass filter props
    - File: `frontend/components/dashboard/dashboard-client.tsx`
...
- [ ] 8.0 Complete responsive filter layout
  - [ ] 8.1 Add responsive Tailwind classes to filter bar
    - Desktop (>=1024px): `flex flex-row gap-4`
    - Tablet (768-1023px): `flex flex-wrap gap-3`
    - Mobile (<768px): `flex flex-col gap-2 w-full`
  - [ ] 8.2 Make individual filter controls responsive
...
- [ ] 9.0 Review and fill critical test gaps
