...
- [x] 1.0 Complete types and constants
...
- [x] 2.0 Complete API client function
...
- [x] 3.0 Complete ScoreChart component
...
- [x] 4.0 Complete testing and verification
  ...
  - [x] 4.2 Add up to 3 additional integration tests if needed
