...
- [ ] 1.0 Complete transaction grouping utilities
  - [ ] 1.1 Write 4-6 unit tests for grouping logic
  ...
  - [ ] 1.2 Create `frontend/lib/transaction-grouping.ts` with types and functions
...
- [ ] 2.0 Complete translation updates
  - [ ] 2.1 Add tab labels to `frontend/lib/translations.ts`
...
- [ ] 3.0 Complete GroupedTransactionList component
  - [ ] 3.1 Write 4-6 component tests
  ...
  - [ ] 3.2 Create `TransactionRow` internal component
  ...
  - [ ] 3.3 Create `SubcategoryGroup` internal component
  ...
  - [ ] 3.4 Create `GroupedTransactionList` main component
  ...
  - [ ] 3.5 Ensure component tests pass
...
- [ ] 4.0 Complete dashboard integration
  - [ ] 4.1 Modify `dashboard-client.tsx` to use new component
  ...
  - [ ] 4.2 Remove unused pagination/filter props
  ...
  - [ ] 4.4 Run existing dashboard tests to verify no regression
